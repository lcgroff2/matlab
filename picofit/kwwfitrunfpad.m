...
DataFile='lcgjyf061113-rev-para-s1.asc'; % don't get the data and irf files
                            % mixed up, or strange results occur.                            
IRFFile='lcgjyf061113-rev-para-i1.asc'; % to get more fit results and possibly
...
dran=1500:4500; % Data range.  Carefully edit to include 100-300 ps
...
fitinfo.fun{curfun}.lbound=[200];
fitinfo.fun{curfun}.ubound=[4500];
fitinfo.fun{curfun}.curval=[3500];
...
% curfun=curfun+1;
% fitinfo.fun{curfun}.function = 'exp'; % example of exponential
% fitinfo.fun{curfun}.lbound=[70];
% fitinfo.fun{curfun}.ubound=[1900];
