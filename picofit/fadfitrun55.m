...
% curfun=curfun+1;
% fitinfo.fun{curfun}.function = 'exp'; % example of exponential
% fitinfo.fun{curfun}.lbound=[501];
% fitinfo.fun{curfun}.ubound=[3200];
% fitinfo.fun{curfun}.curval=[400];
...
fitinfo.fun{curfun}.ubound=[30 1.2]; % first value is the tau
                                        % parameter, second is beta
fitinfo.fun{curfun}.curval=[3 .3]; % first value is the tau
                                      % parameter, second is beta
...
MAXTIME=60;   %Length of time for Monte Carlo fit.
