...
IRFFile='lcg061411-1.asc';
DataFile='lcg061411-2.asc';
...
% fitinfo.fun{1}.lbound=[5 .2];	%[12 .2]
% fitinfo.fun{1}.ubound=[5000 1];	%[100 1]
% fitinfo.fun{1}.curval=[500 .3];
fitinfo.fun{1}.function = 'exp'; % example of exponential
fitinfo.fun{1}.lbound=[5];
fitinfo.fun{1}.ubound=[10000];
fitinfo.fun{1}.curval=[5000];
% fitinfo.fun{2}.function = 'exp'; % Add this one if you need to use a second exponential
% fitinfo.fun{2}.lbound=[1600];
% fitinfo.fun{2}.ubound=[8000];
% fitinfo.fun{2}.curval=[3000];
